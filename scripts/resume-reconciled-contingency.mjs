...
const RECONCILED_INCIDENTS = Object.freeze({
  ...
  'DEC-TtgchqATot': Object.freeze({
    instrument: 'SOL-USDT-SWAP',
    archiveName: 'second-entry-auto.DEC-TtgchqATot.20260824T1105Z.json',
    bundleArchiveName: 'deadline-contingency.DEC-TtgchqATot.20260824T1105Z.json',
    workflow: 'final-window-contingency-v2',
  }),
});
