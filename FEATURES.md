...
| Evidence-limited second-entry factory — BTC/ETH/SOL, multi-window OI, $3.00 stop / $3.25 planned-loss / $150 notional caps | `@plumb/core`, `@plumb/ops`, `@plumb/executor` | competition | `ops/src/second-entry-decision.test.ts` + `executor/src/competition.test.ts` |
