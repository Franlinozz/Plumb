...
| Evidence-limited second-entry factory — BTC/ETH/SOL, multi-window OI, $1.50 stop / $1.75 planned-loss / $85 notional caps | `@plumb/core`, `@plumb/ops`, `@plumb/executor` | competition | `ops/src/second-entry-decision.test.ts` + `executor/src/competition.test.ts` |
